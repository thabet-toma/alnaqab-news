...
هذا الموقع: PHP + MySQL فقط. البث الصوتي مستضاف خارجياً على Zeno.FM،
فالسيرفر لا يحتاج أي برامج بث — أصغر خطة تكفي.
...
ادخل `https://example.com/admin/` → **إعدادات الراديو** → الصق رابط البث
من Zeno.FM → حفظ.
